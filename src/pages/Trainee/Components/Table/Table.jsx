...
function SimpleTable(props) {
  ...
  return (
    <Paper>
      {console.log('list of trainees in table', data.length)}
...
const EnhancedTabel = withLoaderAndMessage(SimpleTable);
export default withStyles(useStyles)(EnhancedTabel);
